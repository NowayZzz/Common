package com.noway.base.cache.service.impl;

import java.util.List;

import org.springframework.stereotype.Service;

import com.noway.base.cache.NowayCacheManager;
...
public class EhcacheCacheImpl implements ICache {
	...
	public static CacheManager manager = NowayCacheManager.getInstance();
