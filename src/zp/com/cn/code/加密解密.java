...
public class 加密解密 {
	...
	/**
	 * http://172.74.1.9:8080/sysgl/private/login.xp
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		System.out.println(Decrypt("amlhbXh0"));
		System.out.println(Decrypt("amlhbXh0"));
		System.out.println(Encrypt("amlhbXh0"));
	}
	...
	public static String Encrypt(String str) {
		...
		for (i = 0, j = seed; i < len; i++) {
			ret += EncodeChar(((int) str.charAt(i))
					^ ((int) encoderText.charAt(j)));
			if (++j >= elen)
				j = 0;
		}
	...
	public static int DecodeChar(String str, int i)
